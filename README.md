...
### 5. 🤖 Gemini 인텔리전트 요약 (Core Trend Analysis)
- **3일간의 소송센싱 주요 동향 현황**: 수집된 최신 소송 및 뉴스 데이터를 Gemini 모델이 실시간 분석하여 "AI Overview" 스타일의 핵심 트렌드 리포트를 추가 댓글로 발행합니다. (환경변수 설정을 통해 활성화 가능)
