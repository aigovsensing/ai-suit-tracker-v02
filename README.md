...
[8] rank-bm25: A lightweight Python implementation of BM25 algorithms for document ranking. \[Online\]. Available: [https://github.com/dorianbrown/rank_bm25](https://github.com/dorianbrown/rank_bm25)

[9] Google AI for Developers, "Embeddings Guide (text-embedding-004)", Google Gemini API Documentation. \[Online\]. Available: [https://ai.google.dev/gemini-api/docs/embeddings](https://ai.google.dev/gemini-api/docs/embeddings)
